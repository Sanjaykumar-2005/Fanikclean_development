...
<aside class="sidebar">
  ...
  <div class="nav-section">
    ...
    <a href="/leave" class="nav-item <?= strpos($_SERVER['REQUEST_URI'], 'leave') !== false ? 'active' : '' ?>">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="m12 5 7 7-7 7"/></svg>
      Leave
  ...
  <div class="nav-section">
    ...
    <a href="/payroll" class="nav-item <?= strpos($_SERVER['REQUEST_URI'], 'payroll') !== false ? 'active' : '' ?>">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
      Payroll
    </a>
    <a href="/billing" class="nav-item <?= strpos($_SERVER['REQUEST_URI'], 'billing') !== false ? 'active' : '' ?>">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20"/><path d="m17 5-5-3-5 3"/><path d="m17 19-5 3-5-3"/><path d="M2 12h20"/><path d="m5 7-3 5 3 5"/><path d="m19 7 3 5-3 5"/></svg>
      Billing
    </a>
    <a href="/invoices" class="nav-item <?= strpos($_SERVER['REQUEST_URI'], 'invoices') !== false ? 'active' : '' ?>">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"/><polyline points="14 2 14 8 20 8"/></svg>
      Invoices
      <span class="nav-badge">3</span>
    </a>
    <a href="/financial" class="nav-item <?= strpos($_SERVER['REQUEST_URI'], 'financial') !== false ? 'active' : '' ?>">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
      Financial
    </a>
  </div>
  ...
  <div class="nav-section">
    ...
    <a href="/reports" class="nav-item">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21.21 15.89A10 10 0 1 1 8 2.83"/><path d="M22 12A10 10 0 0 0 12 2v10z"/></svg>
      Reports
    </a>
    <a href="/audit" class="nav-item <?= strpos($_SERVER['REQUEST_URI'], 'audit') !== false ? 'active' : '' ?>">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 8v4l3 3"/><circle cx="12" cy="12" r="10"/></svg>
      Audit Log
    </a>
  </div>
  <?php endif; ?>
  ...
  <div class="sidebar-footer" style="padding: 20px;">
    ...
    <a href="/logout" class="nav-item" style="color:var(--danger); width: 100%;">
      <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" x2="9" y1="12" y2="12"/></svg>
      Logout
    </a>
  </div>
</aside>
