          ...
          <div class="card p24">
            ...
            <div class="grid gap16">
              <div class="flex flex-col gap4">
                ...
                <span class="bold"><?= htmlspecialchars($worker['guardian_name'] ?? 'Not Provided') ?></span>
              </div>
              <div class="flex flex-col gap4">
                <span class="fs11 fw5 c-secondary uppercase">Guardian Phone</span>
                <span class="bold"><?= htmlspecialchars($worker['guardian_phone'] ?? 'Not Provided') ?></span>
              </div>
              <div class="flex flex-col gap4">
                <span class="fs11 fw5 c-secondary uppercase">Guardian Place</span>
                <span class="bold"><?= htmlspecialchars($worker['guardian_place'] ?? 'Not Provided') ?></span>
              </div>
            </div>
          </div>
        </div>
